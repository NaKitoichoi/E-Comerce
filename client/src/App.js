...
import { Login, Home, Public, Products, DetailProduct, Blogs, FAQ, FinalRegister, ResetPassword, DetailCart } from './pages/public'
...
import { Persional, MemberLayout, History, WishList, CheckOut } from 'pages/member'
    ...
    <div className="font-main h-screen relative">
      ...
      <Routes>
        ...
        <Route path={path.ADMIN} element={<AdminLayout />}>
          <Route path={path.DAHBOARD} element={<Dashboard />} />
